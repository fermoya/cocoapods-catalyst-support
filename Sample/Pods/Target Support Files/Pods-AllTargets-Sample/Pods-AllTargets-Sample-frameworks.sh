...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DDExpandableButton/DDExpandableButton.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DLPDFRenderer/DLPDFRenderer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DeallocationChecker/DeallocationChecker.framework"
  install_framework "${PODS_ROOT}/DevContactSDK/Pod/DevContactSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Finch/Finch.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/OBSlider/OBSlider.framework"
