...
install_xcframework "${PODS_ROOT}/Google-Mobile-Ads-SDK/Frameworks/GoogleMobileAdsFramework-Current/GoogleMobileAds.xcframework" "Google-Mobile-Ads-SDK" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
