...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationAdColony/AdColonyAdapter-4.8.0.0/AdColonyAdapter.xcframework" "GoogleMobileAdsMediationAdColony" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
